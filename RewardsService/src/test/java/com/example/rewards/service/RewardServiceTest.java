...
public class RewardServiceTest {
	...
	public void setUp() {
		...
		transaction2 = new Transaction(1L, 80.0, LocalDate.parse("2025-01-20"), customer);
	}


	@Test
	public void testCalculateRewards_Success() throws ExecutionException, InterruptedException {
	    ...
	    MonthlyRewards januaryRewards = response.getMonthlyRewards().get("JANUARY");
	    assertNotNull(januaryRewards);
	    assertEquals(120, januaryRewards.getTotalPoints());  
	    assertEquals(200.0, januaryRewards.getTotalAmount(), 0.01);
